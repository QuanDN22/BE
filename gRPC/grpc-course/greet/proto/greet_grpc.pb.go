...
func (x *greetServiceGreetManyTimesClient) Recv() (*GreetRespone, error) {
	m := new(GreetRespone)
...
type GreetService_LongGreetClient interface {
	...
	CloseAndRecv() (*GreetRespone, error)
	grpc.ClientStream
}
...
func (x *greetServiceLongGreetClient) CloseAndRecv() (*GreetRespone, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(GreetRespone)
...
func (x *greetServiceGreetEveryoneClient) Recv() (*GreetRespone, error) {
	m := new(GreetRespone)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *greetServiceGreetManyTimesServer) Send(m *GreetRespone) error {
...
type GreetService_LongGreetServer interface {
	SendAndClose(*GreetRespone) error
...
func (x *greetServiceLongGreetServer) SendAndClose(m *GreetRespone) error {
	return x.ServerStream.SendMsg(m)
}
...
func (x *greetServiceGreetEveryoneServer) Send(m *GreetRespone) error {
	return x.ServerStream.SendMsg(m)
}
